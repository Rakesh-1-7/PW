...
app_data = {
    "name": "Crop Suggestion System",
    "description": "A basic Flask app for Crop ",
    "author": "",
    "html_title": "Peter's Starter Template for a Flask Web App",
    "project_name": "Crop Suggestion System",
...
def submit():
    ...
    result['prediction'] = f"Suggested Crop is {prediction[0].title()}."
